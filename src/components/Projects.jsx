...
const projects = [
  {
    ...
    desc: 'AI-powered Healthcare Professional (HCP) CRM platform for pharmaceutical field representatives. Built with LangGraph-based conversational workflows for interaction logging, sentiment analysis, intelligent intent routing, and AI-driven engagement recommendations. Features a responsive UI, real-time updates, and full-stack deployment.',
    stack: [
  ...
  },
  {
    ...
    desc: 'AI-powered research automation agent using LangChain, CrewAI, and DeepSeek R1. Automates large-scale data collection, analysis, and summarization while leveraging real-time APIs for accurate information retrieval and enhanced insight generation.',
    stack: [
  ...
  },
  {
    ...
    desc: 'Full-stack e-commerce platform with JWT authentication, role-based access control, and RESTful APIs for product CRUD and cart management. Built using a scalable layered backend architecture with optimized entity relationships.',
    stack: [
      { label: 'React.js', color: 'green' },
